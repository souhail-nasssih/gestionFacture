...
<body>
    ...
    <div class="invoice-container">
        ...
        <!-- Informations de facture et client -->
        <div class="invoice-info-section">
            ...
            <div class="client-info">
                <h3>CLIENT</h3>
                <div><strong>Société:</strong> {{ $facture->client->nom }}</div>
                <div><strong>Adresse:</strong> {{ $facture->client->adresse }}</div>
                @if($facture->client->ice)
                    <div><strong>ICE:</strong> {{ $facture->client->ice }}</div>
                @endif
                @if($facture->client->email)
                    <div><strong>E-mail:</strong> {{ $facture->client->email }}</div>
                @endif
            </div>
        </div>
