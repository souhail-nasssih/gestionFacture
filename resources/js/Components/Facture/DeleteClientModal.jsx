...
export default function DeleteClientModal({ facture, onClose, onSuccess }) {
    useEffect(() => {
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-md overflow-hidden">
                ...
                <div className="p-6">
                    <p className="text-gray-600 dark:text-gray-300 mb-4">
                        Êtes-vous sûr de vouloir supprimer la facture client n°{" "}
                ...
                <div className="bg-gray-50 dark:bg-gray-700 px-6 py-4 flex flex-col sm:flex-row-reverse sm:justify-start sm:space-x-reverse sm:space-x-3">
                    <Link
                        href={route("facture-clients.destroy", facture?.id)}
                        method="delete"
                        as="button"
