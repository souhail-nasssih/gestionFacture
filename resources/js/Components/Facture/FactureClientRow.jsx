            ...
            <tr className="hover:bg-gray-50 dark:hover:bg-gray-700">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex space-x-2">
                        <button onClick={handleToggleExpand} className="p-1.5 text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300 hover:bg-blue-100 dark:hover:bg-blue-900 rounded-md transition-colors" title={expanded ? "Masquer les détails" : "Afficher les détails"}>
                            <Eye className="h-5 w-5" />
                        </button>
                        <button onClick={() => onEdit(item)} className="p-1.5 text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300 hover:bg-green-100 dark:hover:bg-green-900 rounded-md transition-colors" title="Modifier cette facture">
                            <Edit2 className="h-5 w-5" />
                        </button>
                        <button onClick={() => onDelete(item)} className="p-1.5 text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300 hover:bg-red-100 dark:hover:bg-red-900 rounded-md transition-colors" title="Supprimer cette facture">
                            <Trash2 className="h-5 w-5" />
                        </button>
                        <button onClick={handlePrint} className="p-1.5 text-purple-600 hover:text-purple-900 dark:text-purple-400 dark:hover:text-purple-300 hover:bg-purple-100 dark:hover:bg-purple-900 rounded-md transition-colors" title="Imprimer cette facture">
